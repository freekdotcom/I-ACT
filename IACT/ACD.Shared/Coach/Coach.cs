...
{
    /*
     * This class ties together all the components required by the application.
     * It starts with a couple of checks(authentication, )
     */
    public partial class Coach
    {
        ...
        public async Task Authenticate(INavigation nav = null)
        {
            ...
            await Alert.Show(
                "Welkom!",
                "Vul hier alstublieft uw pincode in:",
                new StackLayout
                {
                    Children = {
                        entry,
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
                                    ...
                                    message.From.Add(new MailboxAddress("I-ACT", "iact.info.hva@gmail.com"));
...
I-ACT"
                                    ...
                                    using (var client = new SmtpClient())
                                    {
                                        ...
                                        client.Authenticate("iact.info.hva@gmail.com", "I_@cT_In#0");
                ...
                new AlertButton
                {
                    ...
                    Action = () =>
                    {
                        ...
                        entry.Focus();
#if __ANDROID__
                        Android.Widget.Toast.MakeText(Android.App.Application.Context, error.Text, Android.Widget.ToastLength.Short).Show();
#endif
        ...
        SemaphoreSlim checkSemaphore = new SemaphoreSlim(1, 3);
            ...
            if (newTip && !onTipPage)
            {
                await Alert.Show(
                    ...
                    new AlertButton
                    {
                        ...
                        Action = () =>
                        {
                            MainApp.Navigation.PushAsync(new TipPage(this, "New hint"));
                            return false;
                        }
                    }
                );
        ...
        async Task showAlert(bool newTip)
        {
            var onTipPage = (MainApp.Navigation.CurrentPage as CoachPage)?.CurrentPage is TipPage;
            if (newTip && !onTipPage)
            {
